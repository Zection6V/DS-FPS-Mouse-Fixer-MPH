...
始める前に覚えておくこと：バックスペースでプログラムをいつでも終了できます。右シフトで一時停止できます。
...
これは「autoMouseDrag」値を変更することで行えます。これを0に設定すると自動マウスドラッグがオフになり、1に設定するとオンになります。  
デフォルトは1です。
...
入力キーは対応する16進数値で指定する必要があります：https://learn.microsoft.com/en-us/windows/win32/inputdev/virtual-key-codes
